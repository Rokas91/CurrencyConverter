...
class AccountSelectionTableView: BaseTableView {
    ...
    override func onTableViewInitialized() {
        ...
        register(AccountHeaderCell.self, forHeaderFooterViewReuseIdentifier: "accountHeaderCell")
        register(AccountCell.self, forCellReuseIdentifier: "accountCell")
...
extension AccountSelectionTableView: UITableViewDataSource, UITableViewDelegate {
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        let sectionHeader = tableView.dequeueReusableHeaderFooterView(withIdentifier: "accountHeaderCell") as! AccountHeaderCell
